...
const AnalyticsPage: React.FC<Props> = ({ data }) => {
  ...
  return (
    <AppLayout breadcrumbs={breadcrumbs}>
      ...
      <div className="p-6 space-y-6 max-w-[62rem]">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
          <Card>
            <CardHeader>
              <CardTitle>{t("analytics.totalEntries")}</CardTitle>
            </CardHeader>
            <CardContent>
          ...
          <Card>
            <CardHeader>
              <CardTitle>{t("analytics.averagePerDay")}</CardTitle>
            </CardHeader>
            <CardContent>
          ...
          <Card>
            <CardHeader>
              <CardTitle>{t("analytics.maxEntries")}</CardTitle>
            </CardHeader>
            <CardContent>
        ...
        <Card>
          <CardHeader>
            <CardTitle>{t("analytics.entriesOverTime")}</CardTitle>
          </CardHeader>
        ...
        <Card>
          <CardHeader>
            <CardTitle>{t("analytics.moodTrends")}</CardTitle>
          </CardHeader>
            ...
            <Table>
              <TableHeader>
                <TableRow>
                  ...
                  <TableHead>{t("analytics.table.entries")}</TableHead>
                  <TableHead>{t("analytics.table.emotion")}</TableHead>
                  <TableHead>{t("analytics.table.confidence")}</TableHead>
                </TableRow>
              </TableHeader>
              <TableBody>
                {data.map((d) => (

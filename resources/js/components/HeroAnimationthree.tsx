...
const HeroAnimationthree: React.FC<HeroAnimationProps> = ({
  imageBaseUrl,
  totalFrames,
  scale = 1
}) => {
  ...
  }, [imageBaseUrl, totalFrames, scale, i18n.language]);
  ...
  return (
    <canvas
      ...
      style={{
        ...
        transform: i18n.language === "ar" ? "scaleX(-1)" : "none" // optional flip if needed
      }}
    />
  );
};

export default HeroAnimationthree;